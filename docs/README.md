...
- [Application updates](updates.md) — release updates, restart and rollback.
- [Downloading models](model-downloads.md) — Hugging Face GGUF downloads, progress and storage.
