...
CURATED: tuple[Curated, ...] = (
    ...
    Curated(("--mmproj",), label="Vision Projector (--mmproj)"),
    Curated(("--override-tensor",), label="Override Tensor (--override-tensor)"),
    Curated(("--batch-size",), label="Batch Size"),
    Curated(("--threads",), label="CPU Threads"),
    Curated(("--spec-type",), label="Speculative Decoding Type (--spec-type)"),
    Curated(("--spec-draft-n-max",), label="Max Draft Tokens (--spec-draft-n-max)"),
    Curated(("--parallel",), label="Server Slots (--parallel)"),
    Curated(("--tensor-split",), label="Tensor Split (--tensor-split)"),
    Curated(("--load-mode",), label="Model Load Mode (--load-mode)"),
    Curated(("--api-key",), label="API Key (--api-key)"),
)
